...
fn test_request_quotes(
    ...
    let data = vec![quote];
    let ts_init = UnixNanos::default();
    let response = QuotesResponse::new(request_id, client_id, audusd_sim.id, data, UnixNanos::default(), UnixNanos::default(), ts_init, None);
...
fn test_request_trades(
    ...
    let data = vec![trade];
    let ts_init = UnixNanos::default();
    let response = TradesResponse::new(request_id, client_id, audusd_sim.id, data, ts_init, UnixNanos::default(), UnixNanos::default(), None);
...
fn test_request_bars(
    ...
    let data = vec![bar];
    let ts_init = UnixNanos::default();
    let response = BarsResponse::new(request_id, client_id, bar_type, data, ts_init, UnixNanos::default(), UnixNanos::default(), None);
